...
let handler = async (m, { conn, usedPrefix, DevMode }) => { 
    try { 
        ...
        if (global.db.data.users[m.sender].healt > 79) {
            ...
            let img = `${pickRandom(['https://telegra.ph/file/cd45e1cc02b55b65a1545.jpg', 'https://telegra.ph/file/d1915c20ff4a4d5ec4040.jpg', 'https://telegra.ph/file/5803d988fe94b5c55ab03.jpg','https://telegra.ph/file/221532b4940d9e1a54311.jpg', 'https://telegra.ph/file/8ec145917933a2d2dd2a3.jpg'])}`
            let str = `
...
`.trim()
            await conn.sendButtonLoc(m.chat, await (await fetch(img)).buffer(), str, wm, 'Again', '.adventure', m)
            if (mythic > 0) {
